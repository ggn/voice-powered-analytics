...
```bash
aws s3 ls s3://aws-vpa-tweets/tweets/2018/05/01/00/aws-vpa-tweets-3-2018-05-01-00-55-02-f3fa2592-d3b9-441d-947b-f1cd23152db0.gz
```
Download this file to your local directory (Note use **s3://aws-vpa-tweets-euw1...** for EU-WEST-1 [Ireland]):
```bash
aws s3 cp s3://aws-vpa-tweets/tweets/2018/05/01/00/aws-vpa-tweets-3-2018-05-01-00-55-02-f3fa2592-d3b9-441d-947b-f1cd23152db0.gz .
```
